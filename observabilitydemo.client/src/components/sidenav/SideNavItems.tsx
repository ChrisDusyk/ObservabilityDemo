...
import { ListItem, Icon, Tooltip, IconButton, List, Link, Flex, Text } from "@chakra-ui/react";
...
export default function SidenavItems({ navItems, mode = "semi" }: SidenavItemsProps) {
